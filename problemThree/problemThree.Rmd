...
stndfnl 5 b0 1 b1atndrte 1 b2 priGPA 1 b3ACT 1 u,
...
stndfnl = beta0 + beta1atndrte + beta2priGPA + beta3ACT + beta4priGPA.atndrte + u.
...
y1 = alpha0 + alpha1z1 + alpha2z2 + v1.

Find the aj in terms of the betaj  and the pij.

## Part (ii)
Find the reduced form error, v1, in terms of u1, v2, and the parameters.

## Part (iii)
How would you consistently estimate the aj?
