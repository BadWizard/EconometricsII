...
For the CEV assumptions to hold, we must be able to write tvhours = tvhours star + e0, where the measurement error e0 has zero mean and is uncorrelated with tvhours* and each explanatory variable in the equation.
